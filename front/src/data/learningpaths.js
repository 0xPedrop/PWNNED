...
O script malicioso é armazenado no servidor alvo e posteriormente enviado às vítimas.

### Por que é perigoso
Diferentemente do XSS refletido, a vítima não precisa clicar em um link específico.
        `
      },
      {
        title: "DOM-based XSS",
        content: `
## DOM-based XSS
A vulnerabilidade existe no código do lado do cliente.
